...
public class CfgSvc {
    ...
    public void Init() {
        ...
        InitTaskRewardCfg();
        InitMapCfg();
        PECommon.Log("CfgSvc Init Done");  //会加上时间
    }
    ...
    private void InitGuideCfg() {
        ...
        doc.Load(@"C:\Users\Administrator\Source\Repos\Server(remote)\ResCfgs\guide.xml");
    ...
    private void InitStrongCfg() {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"C:\Users\Administrator\Source\Repos\Server(remote)\ResCfgs\strong.xml");
    ...
    private void InitTaskRewardCfg() {
        ...
        XmlDocument doc = new XmlDocument();
        doc.Load(@"C:\Users\Administrator\Source\Repos\Server(remote)\ResCfgs\taskreward.xml");
    ...
    private void InitMapCfg() {
        ...
        XmlDocument doc = new XmlDocument();
        doc.Load(@"C:\Users\Administrator\Source\Repos\Server(remote)\ResCfgs\map.xml");
